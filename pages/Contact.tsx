              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-1">04-4212448</p>
                    <a href="tel:044212448" className="text-sm font-bold text-brand-blue hover:underline">Call Now</a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-1">+60 16-439 2448</p>
                    <a href="https://wa.me/60164392448" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-green-600 hover:underline">Chat on WhatsApp</a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-1">mav8.auto@gmail.com</p>
                    <a href="mailto:mav8.auto@gmail.com" className="text-sm font-bold text-brand-blue hover:underline">Send Email</a>
                  </div>
                </div>
